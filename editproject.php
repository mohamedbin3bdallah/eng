...
if(isset($_GET['id']) && abs((int)($_GET['id'])) > 0)
{
	...
	include('develops/editproject-front.php');
	if(!empty($project) && $_SESSION['userid'] == $project['userid'])
	{
?>
<!--Author: W3layouts
...
<section class="contact-us" id="contact">
	<h3 class="text-center"><?php language('editproject'); ?></h3>
	<p class="text-center">
	<?php
				...
				<form action="#" method="post">
					...
					<div class="row">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="name" id="name" value="<?php echo $project['name']; ?>" placeholder="<?php language('projectname'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="value" id="name" value="<?php echo $project['value']; ?>" placeholder="<?php language('value'); ?>" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="location" id="name" value="<?php echo $project['location']; ?>" placeholder="<?php language('location'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<textarea class="form-control" name="description" id="comments" placeholder="<?php language('description'); ?>" rows="5" required><?php echo $project['description']; ?></textarea><br>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="date" class="form-control" name="receiptdate" id="name" value="<?php echo $project['receiptdate']; ?>" placeholder="<?php language('receiptdate'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="date" class="form-control" name="deliverydate" id="name" value="<?php echo $project['deliverydate']; ?>" placeholder="<?php language('deliverydate'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="contractor" id="name" value="<?php echo $project['contractor']; ?>" placeholder="<?php language('contractor'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="consultant" id="name" value="<?php echo $project['consultant']; ?>" placeholder="<?php language('consultant'); ?>" autocomplete="off" required/>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="ownername" id="name" value="<?php echo $project['ownername']; ?>" placeholder="<?php language('name'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<input type="text" class="form-control" name="ownerlocation" id="name" value="<?php echo $project['ownerlocation']; ?>" placeholder="<?php language('location'); ?>" autocomplete="off" required/>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-3 col-sm-push-9 form-group">
						...
						<div class="col-sm-9 col-sm-pull-3 form-group">
							<textarea class="form-control" name="ownercontact" id="comments" placeholder="<?php language('contact'); ?>" rows="5" required><?php echo $project['ownercontact']; ?></textarea><br>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12 form-group">
							<button type="submit" class="btn btn-outline1 btn-lg" name="submit" id="submit"><?php language('edit'); ?></button>
						</div>
					</div>
				</form>			
			</div>
